...
enum AUStringKey: String, CaseIterable {
    ...
    var englishFallback: String {
        switch self {
        case .horizonDescription: return "Automatic or manual leveling, with automatic canvas fill after rotation."
        case .innerStretchDescription: return "Select an area of the input image and stretch it to fill the frame, similar to a document scanning app."
        case .outerStretchDescription: return "Drag the four corners of the output image to stretch it, similar to Final Cut Pro's built-in Transform effect."
        ...
        case .uprightDescription: return "Lightroom-style Upright perspective correction with vertical-only, horizontal-only, and full correction, plus manual, auto-detect with manual selection, and fully automatic modes."
        case .uprightOSCDescription: return "Onscreen guide and candidate line controls for AnyUpright Upright."
        case .analyzeHorizon: return "Analyze Horizontal Line"
        case .analyze: return "Analyze"
        case .rotation: return "Rotation"
        case .fillFrame: return "Fill Frame"
        case .ratio: return "Fill Mode"
        ...
        case .semiAuto: return "Auto Detect + Manual Select"
        ...
        case .horizonAnalysisError: return "Leveling analysis: %@"
        case .uprightAnalysisError: return "Upright analysis: %@"
        case .defaultsNewInstancesOnly: return "Default parameter values apply only to filters added to clips afterward."
