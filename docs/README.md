...
- Enable `Publish OSC` when testing the interactive outline and handles. The four handles should start at the central 80% of the frame, and dragging them around the phone-screen area should not warp the image while editing.
