...
- Verify the Inner Stretch inspector exposes only the manual workflow controls; no detector button, score threshold, or candidate-selection toggle should appear.
