...
- Candidate detection first tries the local ScaleLSD Core ML model and Swift decode/ranking path, then M-LSD, and finally the shared Sobel/Hough detector when earlier model resources are missing or inference fails.
