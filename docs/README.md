...
- Enable `Choose from detections`; the manual quad should remain visible but no longer be hittable. Hovering detected points or lines should turn them yellow. Selecting four points or four lines should write the Source Quad to that proposed quadrilateral and automatically disable `Choose from detections`.
