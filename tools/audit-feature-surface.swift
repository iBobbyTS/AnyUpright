...
struct AuditFeatureSurface {
    ...
    private static func auditPluginDefaults(_ defaults: String, ui: String, warp: String) throws {
        ...
        try require(ui, "let footerStack = NSStackView(views: [statusLabel, resetButton, saveButton])", "Defaults actions share one footer stack")
        ...
        try require(ui, "statusLabel.setContentCompressionResistancePriority(.defaultLow, for: .horizontal)", "Defaults status yields horizontal space before action buttons")
