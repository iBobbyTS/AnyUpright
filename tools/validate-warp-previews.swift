...
struct ValidateWarpPreviews {
    static func run() throws {
        ...
        let expected = [
            ...
            PreviewExpectation(fileName: "stretch-inner-stretch-adjuster-preview.png", minimumLitPixelRatio: 0.10),
            PreviewExpectation(fileName: "stretch-inner-stretch-apply-preview.png", minimumLitPixelRatio: 0.10),
            PreviewExpectation(fileName: "stretch-output-corners-preview.png", minimumLitPixelRatio: 0.10),
